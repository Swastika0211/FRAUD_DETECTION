...
DARK = dict(plot_bgcolor='#0d1526', paper_bgcolor='#0d1526',
            font_color='#8ab4d8', gridcolor='#1a2a4a')
...
if page_key == "Dashboard":
    ...
    with col1:
        ...
        fig.add_annotation(text=f"{fraud_rate:.1f}%", x=0.5, y=0.55, font_size=24,
                           font_color='#ef4444', showarrow=False, font_family='Space Mono')
        fig.add_annotation(text="fraud rate", x=0.5, y=0.42, font_size=11,
                           font_color='#5a7ab0', showarrow=False)
        fig.update_layout(**DARK, height=280, margin=dict(t=10,b=10,l=10,r=10),
                          showlegend=True, legend=dict(font_color='#8ab4d8',bgcolor='rgba(0,0,0,0)'))
    ...
    with col2:
        ...
        fig2.update_layout(**DARK, height=280, margin=dict(t=10,b=30,l=40,r=10),
                           barmode='overlay', xaxis_title="log(Amount)", yaxis_title="Density",
                           legend=dict(font_color='#8ab4d8',bgcolor='rgba(0,0,0,0)'))
    ...
    with col3:
        ...
        fig3 = go.Figure(go.Bar(x=hourly['TransactionHour'], y=hourly['FraudRate'],
                                marker=dict(color=hourly['FraudRate'],
                                            ...
                                            showscale=False)))
        fig3.update_layout(**DARK, height=260, margin=dict(t=10,b=30,l=40,r=10),
    ...
    with col4:
        ...
        fig4 = go.Figure(go.Bar(x=pm['FraudRate'], y=pm['PaymentMethod'], orientation='h',
                                ...
                                textposition='outside', textfont_color='#8ab4d8'))
        fig4.update_layout(**DARK, height=260, margin=dict(t=10,b=10,l=10,r=60),
    ...
    with col5:
        ...
        fig5.update_layout(**DARK, height=260, margin=dict(t=10,b=30,l=40,r=10), coloraxis_showscale=False)
    ...
    with col6:
        ...
        fig6.update_layout(**DARK, height=260, margin=dict(t=10,b=10,l=40,r=10),
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    if "models" not in st.session_state:
        ...
        with col1:
            ...
            fig_roc.update_layout(**DARK,height=340,margin=dict(t=10,b=40,l=50,r=10),
                                  xaxis_title="False Positive Rate",yaxis_title="True Positive Rate",
                                  legend=dict(font_color='#8ab4d8',bgcolor='rgba(0,0,0,0)',x=0.55,y=0.1))
        ...
        with col2:
            ...
            fig_bar.update_layout(**DARK,height=340,barmode='group',
        ...
        for col,(name,r) in zip(cm_cols, results.items()):
            with col:
                ...
                fig_cm = ff.create_annotated_heatmap(
                    ...
                    font_colors=['#e8f0ff'])
                fig_cm.update_layout(**DARK,height=260,margin=dict(t=30,b=10,l=10,r=10),
                                     title=dict(text=name,font_color='#8ab4d8',font_size=13))
        ...
        fig_imp = go.Figure(go.Bar(x=imp.values, y=imp.index, orientation='h',
                                   ...
                                   textposition='outside',textfont_color='#8ab4d8'))
        fig_imp.update_layout(**DARK,height=420,margin=dict(t=10,b=10,l=10,r=60),xaxis_title="Importance")
    ...
    if "models" not in st.session_state:
        ...
        if st.button("🔍  Analyze Transaction"):
            ...
            with rc1:
                ...
                fig_g.update_layout(**DARK,height=280,margin=dict(t=20,b=10,l=30,r=30))
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    fig_hm.update_layout(**DARK,height=300,margin=dict(t=10,b=40,l=50,r=10))
    ...
    with col1:
        ...
        fig_ab = go.Figure(go.Bar(x=ab['AgeBucket'].astype(str), y=ab['FraudRate'],
                                   ...
                                   textposition='outside',textfont_color='#8ab4d8'))
        fig_ab.update_layout(**DARK,height=300,margin=dict(t=10,b=40,l=50,r=10),
    ...
    with col2:
        ...
        fig_id.update_layout(**DARK,height=300,margin=dict(t=10,b=40,l=50,r=10),
                             yaxis_title="Fraud Rate (%)",
                             legend=dict(bgcolor='rgba(0,0,0,0)',font_color='#8ab4d8'))
    ...
    with col3:
        ...
        fig_sc.update_layout(**DARK,height=280,margin=dict(t=10,b=40,l=50,r=10),
    ...
    with col4:
        ...
        fig_ph.update_layout(**DARK,height=280,margin=dict(t=10,b=30,l=50,r=10),
                             yaxis_title="Fraud Rate (%)",
                             legend=dict(bgcolor='rgba(0,0,0,0)',font_color='#8ab4d8'))
